...
public class BaseTest {
	...
	public void beforeTestMethod() {
		...
		extent.setSystemInfo("Automation Tester", "Hitesh Pande");
	}
	
	@BeforeMethod
	@Parameters(value= {"browserName"}) // picking up browser name from testng
	...
	@AfterMethod
	public void aftertMethodMethod(ITestResult result) {
